...
const Footer = () => {
    return (
        <footer className="flex flex-col items-center md:flex-row md:justify-around mt-auto font-mulish bg-main-dark-green">
            <section className="p-7 flex flex-col items-center text-center md:items-start md:text-start">
                <img className="w-48" src={footerIMG} />
                <p className="w-96 text-lg pt-7 text-main-white">
            ...
            <div className="flex items-center mb-10 md:mt-28 md:mb-0">
                ...
                <button className="w-10 border-2 rounded-full ml-5 p-1 text-main-white opacity-30 transition duration-300 ease-in-out hover:text-main-green hover:opacity-100 hover:scale-110 hover:rotate-full">
                    <ArrowUpIcon />
                </button>
            </div>
        </footer>
